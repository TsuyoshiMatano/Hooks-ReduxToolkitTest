...
describe("reducer of ReduxToolKit", () => {
    ...
    describe("incrementByAmout action", ()=>{
        ...
        it("Should inceremant by payload value with mode 0", ()=>{
            const action = {type: incrementByAmount.type, payload : 3}
            const state = reducer(initialState,action);
            expect(state.value).toEqual(4);
        })
        it("Should inceremant by 100 * payload value with mode 1", ()=>{
            let initialState = {
                mode: 1,
                value: 1,
            }
        ...
        it("Should inceremant by 10000 * payload value with mode 2", ()=>{
            let initialState = {
                mode: 2,
                value: 1,
            }
