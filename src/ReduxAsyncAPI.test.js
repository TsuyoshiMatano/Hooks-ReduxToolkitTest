...
//外部のJSONプレイスフォルダーのAPIのエンドポイントをモックサーバーウォーカーを使ってモッキングする
import { rest } from "msw";
import {setupServer} from "msw/node";

//テスト用のRedux Storeを作るために
import {Provider} from "react-redux";
import { configureStore } from "@reduxjs/toolkit";
import customCounterReducer from "../src/features/customConter/customCounterSlice";
